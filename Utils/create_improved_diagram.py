...
output_path = "/Users/skrinak/Development/Noggin/Documents/Images/noggin_architecture_improved"
...
with Diagram("Noggin mTBI Management Architecture", 
    ...
    escalation_lambda >> Edge() >> bedrock
    bedrock >> Edge() >> escalation_agent
